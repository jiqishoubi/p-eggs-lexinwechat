...
function ImageFlow() {
    ...
    this.init = function (options) {
        ...
        if (ImageFlowDiv) {
            ...
            if (this.createStructure()) {
                ...
                ImageFlowDiv.style.height = height * 1.5 + 'px';
    ...
    this.refresh = function () {
        ...
        //tongzhou
        this.imagesDivWidth = document.getElementById("LoopDiv").clientWidth
        console.log(this.imagesDivWidth)
        ...
        console.log(this.imagesDivHeight)

        /* Change imageflow div properties */
        my.ImageFlowDiv.style.height = my.maxHeight * 1.5 + 'px';
            ...
            if (image !== null && image.nodeType == 1 && image.nodeName == 'IMG') {
                ...
                if (my.firstRefresh) {
                    if (image.getAttribute('width') !== null && image.getAttribute('height') !== null) {
                        ...
                        // tongzhou
                        multi = 1
                        // image.w = image.getAttribute('width') * multi;
